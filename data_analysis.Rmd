...
models_w_prior_arg_2019 <- list() #list to store different models
for(p in 1:prior_models){
model <- bsts_run_w_prior(y = train_arg$cc, 
                                            model_spec = cc ~ ., 
                                            seasons = 12, 
                                            iterations = 20000, 
                                            train_df = train_arg, 
...
models_w_prior_arg_2019[[p]] <- model 

}


models_w_prior_arg_2021 <- list() 
for(p in 1:prior_models){
model_21 <- bsts_run_w_prior(y = train_arg_21$cc, 
                                            model_spec = cc ~ ., 
                                            seasons = 12, 
                                            iterations = 20000, 
                                            ...
                                            initial_year = 2019, 
                                            spike = prob_inclusion[p])
models_w_prior_arg_2021[[p]] <- model_21 
...
##2017-2019
pred_w_gt_prior_arg_19 <- list()

for(p in 1:prior_models){
pred_w_gt_prior_arg_19[[p]] <- prediction_df_and_plot(model = models_w_prior_arg_2019[[p]] , 
                                              full_df = df_arg_2019, 
                                              train_df = train_arg, 
                                              test_1= test_arg_oct, 
                                              test_2= test_arg_nov, 
...
##2019-2021
pred_w_gt_prior_arg_21  <- list()

for(p in 1:prior_models){

pred_w_gt_prior_arg_21[[p]] <- prediction_df_and_plot(model = models_w_prior_arg_2021[[p]] ,  
                                              full_df= df_arg_2021, 
                                              train_df= train_arg_21, 
                                              test_1= test_arg_21_apr, 
                                              test_2= test_arg_21_may, 
...
pred_w_gt_prior_arg_19[[4]]$plot

pred_w_gt_prior_arg_21[[2]]$plot
```

```{r}
#See errors of model w. priors first
errors_prior_arg_2019  <- NULL
errors_prior_arg_2021  <- NULL
for (p in 1:prior_models)
    {
    errors_prior_arg_2019 <- rbind(errors_prior_arg_2019, 
                                get_errors(MAPE_df = pred_w_gt_prior_arg_19[[p]]$MAPE_raw, test_year = 2019, country = "Argentina", reg = TRUE))
}

errors_prior_arg_2019 <- cbind(errors_prior_arg_2019, prob_inclusion)

for (p in 1:prior_models)
    {
    errors_prior_arg_2021 <- rbind(errors_prior_arg_2021, 
                                get_errors(MAPE_df = pred_w_gt_prior_arg_21[[p]]$MAPE_raw, test_year = 2021, country = "Argentina", reg = TRUE))
}

errors_prior_arg_2021 <- cbind(errors_prior_arg_2021, prob_inclusion)

errors_prior_arg <- rbind(errors_prior_arg_2019, errors_prior_arg_2021)

print(errors_prior_arg)

write_xlsx(errors_prior_arg, "errors_prior_arg.xlsx")
```
...
mape_w_priors_arg_19 <- get_errors(MAPE_df = pred_w_gt_prior_arg_19[[4]]$MAPE_raw, test_year = 2019, country = "argentina", reg = TRUE)
mape_w_priors_arg_21 <- get_errors(MAPE_df = pred_w_gt_prior_arg_21[[2]]$MAPE_raw, test_year = 2021, country = "argentina", reg = TRUE)
```

#### Spike and Slab Exploration
```{r}
#Relevant variables 2017-2019
param_values_bsts(model_w_gt_arg_19, 0.01)
var_inclusion_bsts(model_w_gt_arg_19, 0.01)

#Relevant variables 2017-2019
param_values_bsts(models_w_prior_arg_2019[[4]], 0.01)
var_inclusion_bsts(models_w_prior_arg_2019[[4]], 0.01)

#Relevant variables 2019-2021
param_values_bsts(model_w_gt_arg_21, 0.03)
var_inclusion_bsts(model_w_gt_arg_21)

#Relevant variables 2017-2019
param_values_bsts(models_w_prior_arg_2021[[1]], 0.01)
var_inclusion_bsts(models_w_prior_arg_2021[[1]], 0.01)
```
...
#2017-2019
#Consider model sizes from 3 to 9
models_w_prior_bra_2019 <- list() #list to store different models
for(p in 1:prior_models){
model <- bsts_run_w_prior(y = train_bra$cc, 
                                            model_spec = cc ~ ., 
                                            seasons = 12, 
                                            iterations = 20000, 
                                            train_df = train_bra, 
...
models_w_prior_bra_2019[[p]] <- model 

}


models_w_prior_bra_2021 <- list() 
for(p in 1:prior_models){
model_21 <- bsts_run_w_prior(y = train_bra_21$cc, 
                                            model_spec = cc ~ ., 
                                            seasons = 12, 
                                            iterations = 20000, 
                                            ...
                                            initial_year = 2019, 
                                            spike = prob_inclusion[p])
models_w_prior_bra_2021[[p]] <- model_21 
...
##2017-2019
pred_w_gt_prior_bra_19 <- list()

for(p in 1:prior_models){
pred_w_gt_prior_bra_19[[p]] <- prediction_df_and_plot(model = models_w_prior_bra_2019[[p]] , 
                                              full_df = df_bra_2019, 
                                              train_df = train_bra, 
                                              test_1= test_bra_oct, 
                                              test_2= test_bra_nov, 
...
##2019-2021
pred_w_gt_prior_bra_21  <- list()

for(p in 1:prior_models){

pred_w_gt_prior_bra_21[[p]] <- prediction_df_and_plot(model = models_w_prior_bra_2021[[p]] ,  
                                              full_df= df_bra_2021, 
                                              train_df= train_bra_21, 
                                              test_1= test_bra_21_apr, 
                                              test_2= test_bra_21_may, 
...
```{r}
#Plot the model with the smaller error (prior)
pred_w_gt_prior_bra_19[[4]]$plot

pred_w_gt_prior_bra_21[[2]]$plot
```

```{r}
#See errors of model w. priors first
errors_prior_bra_2019  <- NULL
errors_prior_bra_2021  <- NULL
for (p in 1:prior_models)
    {
    errors_prior_bra_2019 <- rbind(errors_prior_bra_2019, 
                                get_errors(MAPE_df = pred_w_gt_prior_bra_19[[p]]$MAPE_raw, test_year = 2019, country = "Brazil", reg = TRUE))
}

errors_prior_bra_2019 <- cbind(errors_prior_bra_2019, prob_inclusion)

for (p in 1:prior_models)
    {
    errors_prior_bra_2021 <- rbind(errors_prior_bra_2021, 
                                get_errors(MAPE_df = pred_w_gt_prior_bra_21[[p]]$MAPE_raw, test_year = 2021, country = "Brazil", reg = TRUE))
}

errors_prior_bra_2021 <- cbind(errors_prior_bra_2021, prob_inclusion)

errors_prior_bra <- rbind(errors_prior_bra_2019, errors_prior_bra_2021)

print(errors_prior_bra)
write_xlsx(errors_prior_bra, "errors_prior_bra.xlsx")
```
...
mape_w_priors_bra_19 <- get_errors(MAPE_df = pred_w_gt_prior_bra_19[[4]]$MAPE_raw, test_year = 2019, country = "Brazil", reg = TRUE)
mape_w_priors_bra_21 <- get_errors(MAPE_df = pred_w_gt_prior_bra_21[[2]]$MAPE_raw, test_year = 2021, country = "Brazil", reg = TRUE)
```

#### Spike and Slab Exploration
```{r}
#Relevant variables 2017-2019
param_values_bsts(model_w_gt_bra_19, 0.01)
var_inclusion_bsts(model_w_gt_bra_19, 0.01)

#Relevant variables 2019-2021
param_values_bsts(model_w_gt_bra_21, 0.03)
var_inclusion_bsts(model_w_gt_bra_21)
```
...
#2017-2019
#Consider model sizes from 3 to 9
models_w_prior_chi_2019 <- list() #list to store different models
for(p in 1:prior_models){
model <- bsts_run_w_prior(y = train_chi$cc, 
                                            model_spec = cc ~ ., 
                                            seasons = 12, 
                                            iterations = 20000, 
                                            train_df = train_chi, 
...
models_w_prior_chi_2019[[p]] <- model 

}


models_w_prior_chi_2021 <- list() 
for(p in 1:prior_models){
model_21 <- bsts_run_w_prior(y = train_chi_21$cc, 
                                            model_spec = cc ~ ., 
                                            seasons = 12, 
                                            iterations = 20000, 
                                            ...
                                            initial_year = 2019, 
                                            spike = prob_inclusion[p])
models_w_prior_chi_2021[[p]] <- model_21 
...
##2017-2019
pred_w_gt_prior_chi_19 <- list()

for(p in 1:prior_models){
pred_w_gt_prior_chi_19[[p]] <- prediction_df_and_plot(model = models_w_prior_chi_2019[[p]] , 
                                              full_df = df_chi_2019, 
                                              train_df = train_chi, 
                                              test_1= test_chi_oct, 
                                              test_2= test_chi_nov, 
...
##2019-2021
pred_w_gt_prior_chi_21  <- list()

for(p in 1:prior_models){

pred_w_gt_prior_chi_21[[p]] <- prediction_df_and_plot(model = models_w_prior_chi_2021[[p]] ,  
                                              full_df= df_chi_2021, 
                                              train_df= train_chi_21, 
                                              test_1= test_chi_21_apr, 
                                              test_2= test_chi_21_may, 
...
```{r}
#Plot the model with the smaller error (prior)
pred_w_gt_prior_chi_19[[4]]$plot

pred_w_gt_prior_chi_21[[2]]$plot
```

```{r}
#See errors of model w. priors first
errors_prior_chi_2019  <- NULL
errors_prior_chi_2021  <- NULL
for (p in 1:prior_models)
    {
    errors_prior_chi_2019 <- rbind(errors_prior_chi_2019, 
                                get_errors(MAPE_df = pred_w_gt_prior_chi_19[[p]]$MAPE_raw, test_year = 2019, country = "Chile", reg = TRUE))
}

errors_prior_chi_2019 <- cbind(errors_prior_chi_2019, prob_inclusion)

for (p in 1:prior_models)
    {
    errors_prior_chi_2021 <- rbind(errors_prior_chi_2021, 
                                get_errors(MAPE_df = pred_w_gt_prior_chi_21[[p]]$MAPE_raw, test_year = 2021, country = "Chile", reg = TRUE))
}

errors_prior_chi_2021 <- cbind(errors_prior_chi_2021, prob_inclusion)

errors_prior_chi <- rbind(errors_prior_chi_2019, errors_prior_chi_2021)

print(errors_prior_chi)
write_xlsx(errors_prior_chi, "errors_prior_chi.xlsx")
```
...
mape_w_priors_chi_19 <- get_errors(MAPE_df = pred_w_gt_prior_chi_19[[4]]$MAPE_raw, test_year = 2019, country = "Chile", reg = TRUE)
mape_w_priors_chi_21 <- get_errors(MAPE_df = pred_w_gt_prior_chi_21[[2]]$MAPE_raw, test_year = 2021, country = "Chile", reg = TRUE)
```

#### Spike and Slab Exploration
```{r}
#Relevant variables 2017-2019
param_values_bsts(model_w_gt_chi_19, 0.01)
var_inclusion_bsts(model_w_gt_chi_19, 0.01)

#Relevant variables 2019-2021
param_values_bsts(model_w_gt_chi_21, 0.03)
var_inclusion_bsts(model_w_gt_chi_21)
```
...
```{r}
#2017-2019
models_w_prior_col_2019 <- list() #list to store different models
for(p in 1:prior_models){
model <- bsts_run_w_prior(y = train_col$cc, 
                                            model_spec = cc ~ ., 
                                            seasons = 12, 
                                            iterations = 20000, 
                                            train_df = train_col, 
...
models_w_prior_col_2019[[p]] <- model 

}


models_w_prior_col_2021 <- list() 
for(p in 1:prior_models){
model_21 <- bsts_run_w_prior(y = train_col_21$cc, 
                                            model_spec = cc ~ ., 
                                            seasons = 12, 
                                            iterations = 20000, 
                                            ...
                                            initial_year = 2019, 
                                            spike = prob_inclusion[p])
models_w_prior_col_2021[[p]] <- model_21 
...
##2017-2019
pred_w_gt_prior_col_19 <- list()

for(p in 1:prior_models){
pred_w_gt_prior_col_19[[p]] <- prediction_df_and_plot(model = models_w_prior_col_2019[[p]] , 
                                              full_df = df_col_2019, 
                                              train_df = train_col, 
                                              test_1= test_col_oct, 
                                              test_2= test_col_nov, 
...
##2019-2021
pred_w_gt_prior_col_21  <- list()

for(p in 1:prior_models){

pred_w_gt_prior_col_21[[p]] <- prediction_df_and_plot(model = models_w_prior_col_2021[[p]] ,  
                                              full_df= df_col_2021, 
                                              train_df= train_col_21, 
                                              test_1= test_col_21_apr, 
                                              test_2= test_col_21_may, 
...
```{r}
#Plot the model with the smaller error (prior)
pred_w_gt_prior_col_19[[4]]$plot

pred_w_gt_prior_col_21[[2]]$plot
```

```{r}
#See errors of model w. priors first
errors_prior_col_2019  <- NULL
errors_prior_col_2021  <- NULL
for (p in 1:prior_models)
    {
    errors_prior_col_2019 <- rbind(errors_prior_col_2019, 
                                get_errors(MAPE_df = pred_w_gt_prior_col_19[[p]]$MAPE_raw, test_year = 2019, country = "Colombia", reg = TRUE))
}

errors_prior_col_2019 <- cbind(errors_prior_col_2019, prob_inclusion)

for (p in 1:prior_models)
    {
    errors_prior_col_2021 <- rbind(errors_prior_col_2021, 
                                get_errors(MAPE_df = pred_w_gt_prior_col_21[[p]]$MAPE_raw, test_year = 2021, country = "Colombia", reg = TRUE))
}

errors_prior_col_2021 <- cbind(errors_prior_col_2021, prob_inclusion)

errors_prior_col <- rbind(errors_prior_col_2019, errors_prior_col_2021)

print(errors_prior_col)
write_xlsx(errors_prior_col, "errors_prior_col.xlsx")
```
...
mape_w_priors_col_19 <- get_errors(MAPE_df = pred_w_gt_prior_col_19[[4]]$MAPE_raw, test_year = 2019, country = "Colombia", reg = TRUE)
mape_w_priors_col_21 <- get_errors(MAPE_df = pred_w_gt_prior_col_21[[2]]$MAPE_raw, test_year = 2021, country = "Colombia", reg = TRUE)
```

#### Spike and Slab Exploration
```{r}
#Relevant variables 2017-2019
param_values_bsts(model_w_gt_col_19, 0.01)
var_inclusion_bsts(model_w_gt_col_19, 0.01)

#Relevant variables 2019-2021
param_values_bsts(model_w_gt_col_21, 0.03)
var_inclusion_bsts(model_w_gt_col_21)
```
...
```{r}
#Relevant variables 2017-2019
param_values_bsts(model_w_gt_mex_19, 0.01)
var_inclusion_bsts(model_w_gt_mex_19, 0.01)

#Relevant variables 2019-2021
param_values_bsts(model_w_gt_mex_21, 0.03)
var_inclusion_bsts(model_w_gt_mex_21)
```
